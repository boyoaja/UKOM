...
public class JFLBarang extends javax.swing.JFrame {
    ...
    public JFLBarang(JFPenjualan jual) {
        initComponents();
    ...
    private void jbCariPenyakitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCariPenyakitActionPerformed
        ...
        if (jTable2.getSelectedRow()>=0){
            ...
            jual.getNamaBarang().setText(jTable2.getValueAt(jTable2.getSelectedRow(),2).toString());
            jual.getHargasatuan().setText(jTable2.getValueAt(jTable2.getSelectedRow(),3).toString());
            this.dispose();
        } else {
